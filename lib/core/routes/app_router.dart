...
class AppRouter {
  ...
  static Future<T?> navigateAndClearStack<T>(BuildContext context, String routeName) {
  ...
  static Future<void> openEditor(BuildContext context, {String? noteId, String? folderId}) {
